...
async function revealPayoutAccountResponse(request, env) {
  ...
  // Reuse the existing audit log when available; revealing remains functional before that table exists.
  await env.DB.prepare(`
    INSERT INTO tenant_audit_logs (
      id, tenant_slug, actor_uid, action, entity_type, entity_id, metadata_json, created_at
